...
use cli::{
    ...
    Cli, CommandAction, Commands, ConfigAction, GatewayAction, LogsAction, PluginsAction,
...
use commands::{
    ...
    cmd_gateway_rotate_store_incarnation, cmd_gateway_start, cmd_gateway_stop, cmd_gateway_token,
