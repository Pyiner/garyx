...
pub use transcript_render_state::{
    ...
    RenderCapsuleCard, RenderDelta, RenderDeltaError, RenderFilteredPlaceholder,
    RenderMessagePresentation, RenderMessageRef, RenderPlaceholderFilterReason,
    RenderProgressLocus, RenderRow, RenderRowsDigest, RenderSnapshot, RenderStepItem,
    RenderStepRow, RenderTailActivity, RenderToolEntry, RenderToolEntryStatus, RenderToolGroup,
    RenderToolGroupStatus, RenderUserTurnRow, RenderWindow, TranscriptRenderPrefixState,
    apply_render_delta, apply_transcript_render_prefix_record, derive_render_delta,
    derive_render_delta_from_base, final_assistant_text_from_render_records,
